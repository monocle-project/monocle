...
BOOST_AUTO_TEST_CASE(key_test1)
{
    ...
    const char secret[] = {95, 112, 167, 123, 50, 38, 10, 122, 50, 198, 34, 66, 56, 31, 186, 44, 244, 12, 14, 32, 158, 102, 90, 121, 89, 65, 142, 174, 79, 45, 162, 43, 1};
    CBitcoinSecret ephemKeyBytes;
    ephemKeyBytes.SetString(secret);
    CKey ephemKey  = ephemKeyBytes.GetKey();

    printf("    * pubkey (hex): %s\n", HexStr(ephemKey.GetPubKey()).c_str());
